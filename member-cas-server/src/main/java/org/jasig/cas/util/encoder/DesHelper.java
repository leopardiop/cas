...
public  class DesHelper {
    ...
    public  static void main(String[] args) {
        DesHelper desObj = new DesHelper();
        String key1 = "1";
        String key2 = "2";
        String key3 = "3";
        String data = "admin";
        String str = desObj.strEnc("123456", "9618862F295480C14D6A65AE763161B8", "admin", null);
        System.out.println(str);
        String dec = desObj.strDec(str, "9618862F295480C14D6A65AE763161B8", "admin", null);
